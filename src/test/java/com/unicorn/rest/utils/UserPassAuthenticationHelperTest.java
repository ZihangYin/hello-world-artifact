...
public class UserPassAuthenticationHelperTest {
    ...
    @Test
    public void validateStrongPassword() throws ValidatorException {
    ...
    @Test
    public void generateHashedPassWithSaltHappyCase() throws UnsupportedEncodingException, NoSuchAlgorithmException, ValidatorException {
    ...
    @Test
    public void authenticatePasswordHappyCase() throws UnsupportedEncodingException, NoSuchAlgorithmException, ValidatorException {
        String passwordOne = "1a2b3c";  
        ByteBuffer saltOne = PasswordAuthenticationHelper.generateRandomSalt();
